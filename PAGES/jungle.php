...
$requete =$bdd->query('SELECT * FROM `tous_les_animaux` WHERE id_habitat=2;');
?>

</head> 

<body style="background-image: url(https://cdn.pixabay.com/photo/2018/01/22/05/53/forest-waterfall-3098200_640.jpg);" >
...
?>
            ...
            <div class="card m-auto border border-light border-5 mt-5 mx-5 " id="card_card" style="min-width: 30rem;height: 400px;box-shadow:5px 5px 14px 14px rgb(215, 253, 158);">
