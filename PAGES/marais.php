...
$requete =$bdd->query('SELECT * FROM `tous_les_animaux` WHERE id_habitat=3;');
?>

</head> 

<body style="background-image: url(https://s3-eu-west-1.amazonaws.com/iya-news-prod.inyourarea.co.uk/2020/12/JS220029866.jpg);" >
  ...
  background: linear-gradient(to right, lightcyan, #7cb8e9);;font-family: cursive;">
...
<!-- fin de la barre ecrit Animaux du mois -->
        ...
        <section class="section_main "style="height: 600px;  font-family: cursive;display:flex;flex-direction: row;overflow-x: scroll; ">
<?php
...
?>
            ...
            <div class="card m-auto border border-light border-5 mt-5 mx-5 " id="card_card" style="min-width: 30rem;height: 400px;box-shadow:5px 5px 14px 14px #68bde4;">
                <img style="max-width: 30rem;max-height: 15rem;" src="<?php echo $row['images_animal']  ?>" id="img_modal" class="card-img-top "
                    alt="..." >
                <div class="card-body " id="card_body" style="border: 2px solid rgb(134, 241, 157); background: -webkit-linear-gradient(to right, lightcyan, #6dd0dd);
  background: linear-gradient(to right, lightcyan, #4093e0);"  >
                <h4 class="card-title"  >
